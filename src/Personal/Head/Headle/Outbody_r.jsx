...
function Outbody_r({ setSelectedDate }) {
  return (
    <>
         <div className='flex'>
          <div className='px-2 '>
            <div className='h-8 w-44 px-2 text-leftborder  border-black font-bold text-white bg-black'>รับทั้งหมด</div>
            <div className='h-14 px-3 pt-1 text-4xl border border-black text-center text-bold text-white bg-red-400 '>45</div>
          </div>
         </div>
         <div className='flex'>
         ...
         <div className='flex pb-4'>
          ...
          <ul className="menu menu-horizontal place-items-center">
           <div className='py-5 px-7 w-32 text-s text-center text-white bg-black'>
               <li><a>Reset</a></li>
           </div>
         </ul>
         </div>
